...
void TitleScene::Init()
{
	...
	tex->LoadTexture("Resource/Title/menu.png", menue);
...
void TitleScene::Draw()
{
	...
	case DisplayState::PvE:
		graph->DrawIntegratedImage(0.0f, 0.0f,
			tex->GetTexture(menue), 0.234275f, 0.52734375f, 1920.0f, 1080.0f, 1, 1);
		break;
	case DisplayState::PvP:
		graph->DrawIntegratedImage(0.0f, 0.0f,
			tex->GetTexture(menue), 0.234375f, 0.52734375f, 1920.0f, 1080.0f, 2, 1);
		break;
	case DisplayState::Help:
		graph->DrawIntegratedImage(0.0f, 0.0f,
			tex->GetTexture(menue), 0.234375f, 0.52734375f, 1920.0f, 1080.0f, 3, 1);
		break;
	}
}
